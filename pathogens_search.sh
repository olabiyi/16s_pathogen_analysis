...
cut -f1 /gpfs0/biores/users/gilloro/Biyi/community_analysis/soil/00.mapping_file_validation/soilType_exp/bacteria/corrected/nonirr_soilType_bacteria_mapping_corrected.txt |sed '1d'| sort -u  > sample_ids.txt 
...
search=pathogens
pathogens=/gpfs0/biores/users/gilloro/Biyi/pathogen_analysis/human_pathogens_list.txt
...
database=/gpfs0/biores/users/gilloro/Biyi/REF_SEQ_16s_microbial/refseq_16s
fasta=/gpfs0/biores/users/gilloro/Biyi/community_analysis/soil/09.pathogen_analysis/soilType/pathogens.fasta
colName=sample
...
identity=_identity
final=final_
#mappping_file=$(cat /gpfs0/biores/users/gilloro/Biyi/community_analysis/soil/00.mapping_file_validation/soilType_exp/bacteria/corrected/nonirr_soilType_bacteria_mapping_corrected.txt)
analyses=_Analysis
...
for treatment in ${samples[*]}; do
   ...
   -m /gpfs0/biores/users/gilloro/Biyi/community_analysis/soil/00.mapping_file_validation/soilType_exp/bacteria/corrected/nonirr_soilType_bacteria_mapping_corrected.txt -s "$colName:$treatment"
